...
Cohesion: 0.05
Nodes (40): 0. Idioma, 10. Frontmatter obrigatório, 11. Análises de ferramentas (fluxo Thoth), 12. Regras de uso do Sinapse pelo Thoth (OBRIGATÓRIO), 13. Regra de resposta por áudio (OBRIGATÓRIO), 1. O que é este vault, 2. Estrutura do vault, 3. Como cada agente usa este vault (+32 more)
...
Cohesion: 0.33
Nodes (8): hook_session_end(), hook_session_start(), hook_tool_detect(), Hook PostToolUse: detecta memory_add e espelha no vault., Lê stdin de forma não-bloqueante usando select (evita hangs interativos)., Hook SessionStart: busca contexto relevante do vault., Hook Stop/SessionEnd: atualiza Current State., _read_stdin_with_timeout()
...
Cohesion: 0.22
Nodes (7): mcpServers, qmd, sinapse-memory, args, command, args, command
...
Cohesion: 0.29
Nodes (7): code:block1 (cerebro/), Decisões tomadas, Estrutura final do vault, O que foi feito, Próximos passos, Stack, Última atualização: 2026-05-22
