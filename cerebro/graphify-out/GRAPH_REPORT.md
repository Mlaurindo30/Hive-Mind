# Graph Report - cerebro  (2026-05-22)

## Corpus Check
- 129 files · ~69,589 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1141 nodes · 1210 edges · 100 communities (93 shown, 7 thin omitted)
...
5. `version_fingerprints` - 13 edges
6. `Functions Reference` - 13 edges
7. `Workflow` - 13 edges
8. `Sinapse Agent — Vault (AGENTS.md)` - 12 edges
9. `JSON Canvas Skill` - 11 edges
10. `debug()` - 10 edges
...
Cohesion: 0.06
Nodes (36): exists, missing, exists, missing, exists, missing, exists, missing (+28 more)
...
Cohesion: 0.08
Nodes (23): frontmatter_required, 1-1, global, incident, person, team, work-note, infrastructure (+15 more)
...
Cohesion: 0.29
Nodes (6): Current State, Decisões tomadas, O que foi feito, Próximos passos, Stack atual, Última atualização: 2026-05-22
...
## Knowledge Gaps
- **712 isolated node(s):** `template`, `version`, `released`, `qmd_index`, `qmd_context` (+707 more)
...
- **Why does `escapeRegex()` connect `Community 3` to `Community 2`, `Community 4`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `resolveQmdEntry()` connect `Community 20` to `Community 33`, `Community 2`, `Community 11`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `runScript()` connect `Community 1` to `Community 33`, `Community 4`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
