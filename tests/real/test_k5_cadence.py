...
CADENCES = [
    ...
    (["scripts/dream/weekly_synthesizer.py", "--real"],
     "cerebro/cerebelo/semanal", 60, "test_weekly_synthesizer"),
    (["scripts/dream/monthly_synthesizer.py", "--real"],
     "cerebro/cerebelo/mensal", 60, "test_monthly_synthesizer"),
    (["scripts/dream/yearly_synthesizer.py", "--real"],
     "cerebro/cerebelo/anual", 60, "test_yearly_synthesizer"),
