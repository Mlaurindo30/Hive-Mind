...
| 14 | [Model Gateway + Capability Registry](14-model-gateway.md) | Priority 1 — roteamento de LLM por role/capability, adapters OpenAI-compatible (LM Studio, llama.cpp, vLLM, SGLang, LiteLLM), fallback explícito, `MODEL_GATEWAY_ENABLED` (opt-in, `false` por padrão) | Engenharia / ML Engineers |
