...
| M1 | Claude Mem recebe project canônico | integration | **DONE** | `pytest tests/integration/test_capture_isolated_worker_delivery.py` | 8 passed; **worker real descartável**, transporte real sem stub, linha existe na store temporária com `project='Hive-Mind'`; rótulo livre ausente | D004-R2W |
