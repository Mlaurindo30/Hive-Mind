...
| C3 | Antigravity IDE | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como BLOCKED_BY_PROVIDER; D004-P: aceite OK_EXTERNAL — bloqueio externo, não defeito do Hive-Mind |
| C4 | Antigravity CLI | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como BLOCKED_BY_PROVIDER; D004-P: aceite OK_EXTERNAL — bloqueio externo, não defeito do Hive-Mind |
| C5 | Kimi | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como FAIL; D004-P: aceite OK_EXTERNAL — bloqueio externo, não defeito do Hive-Mind |
...
| C8 | Hermes (`C:\Users\miche\AppData\Local\hermes\state.db`) | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como BLOCKED_BY_PROVIDER; D004-P: aceite OK_NOT_REQUIRED — bloqueio externo, não defeito do Hive-Mind |
| C9 | Mimo (`C:\Users\miche\.local\share\mimocode\mimocode.db`) | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como BLOCKED_BY_PROVIDER; D004-P: aceite OK_NOT_REQUIRED — bloqueio externo, não defeito do Hive-Mind |
| C10 | Kilo (fonte Windows real a documentar) | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como BLOCKED_BY_PROVIDER; D004-P: aceite OK_EXTERNAL — bloqueio externo, não defeito do Hive-Mind |
| C11 | Copilot | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como BLOCKED_BY_PROVIDER; D004-P: aceite OK_EXTERNAL — bloqueio externo, não defeito do Hive-Mind |
| C12 | OpenClaw (se instalado) | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como NOT_INSTALLED; D004-P: aceite OK_NOT_REQUIRED — bloqueio externo, não defeito do Hive-Mind |
| C13 | Roo / Screenpipe / SwarmClaw / demais detectados | operational | **DONE** | `hive-mind validate agents` | canário real: ver AUDIT | **D004** — gate de provider. Corrigido em D004-R1: a evidência anterior era mockada (sessão sintética + monkeypatch), viola regra 5 do README; D004-M classificou como NOT_INSTALLED; D004-P: aceite OK_NOT_REQUIRED — bloqueio externo, não defeito do Hive-Mind |
...
| P1 | política de aceite de providers | processo | **DONE** | `reports/provider-capture-matrix.md` | duas colunas: verificação técnica e decisão de aceite; só defeito do Hive-Mind gera BLOCK | D004-P |
