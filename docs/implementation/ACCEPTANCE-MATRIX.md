...
| M14 | envelope canônico sobrevive até a observation | integration | **IN_PROGRESS** | `test_the_identity_envelope_does_not_survive_into_observations` | `observations.metadata` é NULL — medido, e a razão é estrutural: a observation é gerada pelo modelo, não é o payload enviado | M14-A concluída; decisão **B** |
