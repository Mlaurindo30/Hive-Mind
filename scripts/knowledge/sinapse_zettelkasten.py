...
def split_monolithic_file(source_file: str, target_dir: str = "cerebro/cortex/temporal/Hive-Mind/atoms") -> List[str]:
...
def main() -> None:
    ...
    source = sys.argv[2]
    out_dir = sys.argv[3] if len(sys.argv) > 3 else "cerebro/cortex/temporal/Hive-Mind/atoms"
