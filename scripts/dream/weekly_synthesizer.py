...
def _health_section() -> str:
    ...
    try:
        ...
        from scripts.health.health_dashboard import compute_metrics, render_snapshot, evaluate_alerts
        from scripts.knowledge.decision_staleness import stale_decisions, render_markdown
